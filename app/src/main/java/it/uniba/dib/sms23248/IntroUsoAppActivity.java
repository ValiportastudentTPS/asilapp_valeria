...
public class IntroUsoAppActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intro_uso_app);
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    if(parent.getItemAtPosition(position).equals("Scegli utente")){
                        ...
                        if(parent.getItemAtPosition(position).equals("Richiedente Asilo")){
                            Intent intent=new Intent(IntroUsoAppActivity.this, AccessoRichiedente.class);
                        ...
                        if(parent.getItemAtPosition(position).equals("Staff")){
                            Intent intent=new Intent(IntroUsoAppActivity.this, AccessoStaff.class);
                            startActivity(intent);
                            Toast.makeText(parent.getContext(),"Entra come "+item, Toast.LENGTH_SHORT).show();
                        }
                    }
